...
Since working with spatial (and spatio-temporal) data in `R` might seem intimidating, especially for those with less exposure to the language, I'm in the process of [writing some tutorials](http://rpubs.com/nabilabd/) to help ease the learning curve, and make some the code used in this package more readily accessible.
